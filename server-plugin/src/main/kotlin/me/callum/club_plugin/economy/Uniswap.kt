...
object Uniswap {
    ...
    fun updateFactoryAddress(newAddress: String) {
        require(newAddress.startsWith("0x") && newAddress.length == 42) {
            "Invalid factory address: $newAddress"
        }
        v2factoryAddress = newAddress
        println("✅ Uniswap factory address updated to $v2factoryAddress")
    }

    fun updateRouterAddress(newAddress: String) {
        require(newAddress.startsWith("0x") && newAddress.length == 42) {
            "Invalid router address: $newAddress"
        }
        v2routerAddress = newAddress
        println("✅ Uniswap router address updated to $v2routerAddress")
    }
    fun initialize(
